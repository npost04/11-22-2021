...
function init_gear_sets()
    ...
    sets.precast.JA["Repair"] = {--41%
		main="Nibiru Sainti",--10
		ammo = "Automat. Oil +3",
        head=gear.HerculeanRepairHead, --7
		neck="",
		ear1="Guignol earring",
		body="Herculean Vest", --7
		hands=gear.HerculeanRepairHands, --7
    ...
    sets.idle.Pet.MasterDT = sets.idle
    ...
    sets.idle.Pet.Engaged = {
		...
		ear1="Handler's earring +1",
		ear2="Rimeice Earring",--1
		body="Rao Togi +1",--4
		hands="Rao kote +1",--4
		lring="Varar ring +1",
		rring="Thurandaut ring",--3
		back=gear.AutomatonMDTCape,
		waist="Isa belt",--3
    ...
    sets.idle.Pet.Engaged.Acc = {
		...
		range="Animator P +1",
		ammo="Automat. Oil +3",
		head=gear.PUPTaeonChapeau,
		neck="Shepherd's chain",
		ear1="Domes. Earring",
		ear2="Rimeice earring",--3 Haste
		body=gear.PUPTaeonTabard,
		hands=gear.PUPTaeonGloves,
		lring="Varar ring +1",
		rring="Thurandaut ring",--4 Haste
		back=gear.AutomatonODCape, --10Haste
		waist="Klouskap sash +1", --9 Haste
		legs=gear.PUPTaeonTights,
		feet=gear.PUPTaeonBoots
