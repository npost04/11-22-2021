...
body={name="Taeon Tabard", augments={'"Mag.Atk.Bns."+19','"Fast Cast"+5',}},--9
...
ear2="Telos Earring",
body="Malignance Tabard",--9
hands=gear.AdhemarWristbandsMelee,--4
ring1="Chirich Ring",--4
ring2="Chirich Ring",--4
back="Letalis mantle",
waist="Windbuffet belt +1",
legs="Samnuha tights", --6
feet=gear.TAHerculeanBoots --3
}
