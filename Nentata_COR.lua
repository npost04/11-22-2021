...
--------------------------------------
sets.precast.JA['Fold'] = {legs="Lanun gants"}
...
sets.precast.CorsairRoll = {range="Compensator", head="Lanun Tricorne",hands="Navarch's Gants +2", neck="Regal Necklace",back="Camulus's mantle", legs="Desultor Tassets"}
...
sets.precast.CorsairRoll["Courser's Roll"] = set_combine(sets.precast.CorsairRoll, {feet="Navarch's Bottes +2", ring1="Barataria ring"})
sets.precast.CorsairRoll["Blitzer's Roll"] = set_combine(sets.precast.CorsairRoll, {head="Navarch's Tricorne +2", ring1="Barataria ring"})
sets.precast.CorsairRoll["Tactician's Roll"] = set_combine(sets.precast.CorsairRoll, {body="Navarch's Frac +2", ring1="Barataria ring"})
sets.precast.CorsairRoll["Allies' Roll"] = set_combine(sets.precast.CorsairRoll, {hands="Navarch's Gants +2", ring1="Barataria ring"})

sets.precast.LuzafRing = {ring2="Luzaf's Ring"}

sets.precast.CorsairShot = {head="Blood Mask", ammo="Animikii bullet"}
...
sets.precast.WS['Wildfire'].Brew = {ammo="Eminent bullet",
head="Wayfarer Circlet",neck="Stoicheion Medal",ear1="Friomisi Earring",ear2="Hecate's Earring",
body="Manibozho Jerkin",hands="Iuitl Wristbands +1",ring1="Stormsoul Ring",ring2="Demon's Ring",
...
body="Laksamana's Frac",hands="Iuitl Wristbands +1",ring1="Rajas Ring",ring2="Stormsoul Ring",
back="Libeccio Mantle",waist="Elanid belt",legs="Nahtirah Trousers",feet="Iuitl Gaiters +1"}

sets.midcast.RA.Acc = {ammo=gear.RAbullet,
head="Laksamana's Hat",neck="Iqabi necklace",ear1="Clearview Earring",ear2="Volley Earring",
body="Laksamana's Frac",hands="Buremte Gloves",ring1="Hajduk Ring",ring2="Paqichikaji Ring",
back="Gunslinger's cape",waist="Elanid Belt",legs="Thurandaut Tights +1",feet="Scopuli nails +1"}
...
head="Nyame helm",neck="Loricate torque +1",ear1="Clearview Earring",ear2="Volley Earring",
body="Nyame mail",hands="Nyame gauntlets",ring1="Sheltered Ring",ring2="Paguroidea Ring",
...
body="Iuitl Vest",hands="Iuitl Wristbands +1",ring1="Defending Ring",ring2="Dark ring",
back="Repulse Mantle",waist="Flume Belt",legs="Iuitl tights",feet="Iuitl Gaiters +1"}
...
body="Manibozho jerkin",hands="Buremte gloves",ring1="Enlivened Ring",ring2="Epona's Ring",
back="Kayapa cape",waist="Anguinus belt",legs="Manibozho Brais",feet="Iuitl Gaiters +1"}
...
head="Whirlpool Mask",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
body="Iuitl Vest",hands="Iuitl Wristbands +1",ring1="Enlivened Ring",ring2="Epona's Ring",
...
back="Repulse Mantle",waist="Flume Belt",legs="Nahtirah Trousers",feet="Iuitl Gaiters +1"}
end
-------------------------------------------------------------------------------------------------------------------
