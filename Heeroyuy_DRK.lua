...
function init_gear_sets()
	include('augments.lua')
     ...
     sets.precast.FC = {
        ...
        body=gear.OdysseanChestplatePhalanx,
	...
	sets.precast.WS['Savage Blade'].Acc = {
     ...
     sets.engaged = {  --16TA(21TA W/MONTANTE +1  ///14DA(17DA IF BELT CAPPED)
         ammo="Ginsen",
         head="Flam. Zucchetto +2", --4HASTE/5TA
		 neck="Defiant collar",
		 ear1="Cessance Earring",
		 ear2="Brutal Earring",
    	 body="Dagon Breastplate", --1HASTE/5TA
		 hands="Sulev. Gauntlets +2", --3HASTE/6DA
		 ring1="Chirich Ring +1",
		 ring2="Chirich Ring",
         back="Ankou's Mantle",
		 waist="Sailfi Belt +1", --9Haste/2TA
		 legs="Sulev. Cuisses +2", --2HASTE/4TA
		 feet="Flamma gambieras +2" --2HASTE/6DA
     }
     sets.engaged.Mid ={
		ammo="Ginsen",
		...
		rear="Brutal Earring",
		body=gear.ValorousMailSTP, 
		hands="Sulev. gauntlets +2",
		ring1="Chirich Ring +1",
		ring2="Chirich Ring",
		back="Ankou's mantle",
		waist="Ioskeha belt +1",
		legs=gear.OdysseanCuissesSTP,
		feet="Flam. gambieras +2"
     }
     sets.engaged.Acc = set_combine(sets.engaged.Mid, {
		head=gear.valhead_tp,
